 ...
 $(document).ready( function(){
    ...
    $('.nav-toggler').on('click',function(){
        ...
        if(toggle === 'expanded'){
            ...
            $('.nav-toggler').find('.toggle-icon').removeClass('fa-toggle-on').addClass('fa-toggle-off');
            ...
            $('.nav-toggler').find('.toggle-icon').removeClass('fa-toggle-off').addClass('fa-toggle-on');
