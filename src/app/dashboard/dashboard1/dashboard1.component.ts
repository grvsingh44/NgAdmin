...
export class Dashboard1Component implements OnInit {
  ...
  // Line dashboard Weekly chart configuration Starts
  lineChartWeek: Chart = {
    type: 'Line', data: data['LineDashboardWeek'],
    options: {
      axisX: {
        showGrid: false
      },
  ...
  // Line dashboard Monthly chart configuration Starts
  lineChartMonth: Chart = {
    type: 'Line', data: data['LineDashboardMonth'],
    options: {
      axisX: {
        showGrid: false
      },
