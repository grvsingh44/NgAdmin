...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: '', title: 'Dashboard', icon: 'fa fa-home', class: 'has-sub', badge: '2', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
